...
OBJS=$(addprefix $(BUILD_DIR)/, m2x.o client.o json_frozen.o utility.o cmdq.o command.o response.o device.o distribution.o key.o chart.o timestamp.o $(SSL_FILE))
...
.PHONY: clean examples setup docs
